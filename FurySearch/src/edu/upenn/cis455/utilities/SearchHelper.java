...
/*
 * This class provides abstract methods to query the distributed index
 * It finds the appropriate node ID it should query by calculating the hash of the word
 * and sending the request to that IP
 * 
 * 
 */
