...
/*
 * This job calculates term frequency for the images index
 * 
 * 
 */
public class ImageTermFrequency {
	 ...
	 * word;#;DocID	{docWordCount, docWordCount, ..., docWordCount} <word frequency>
	 * 
	 * Reduce emits:
	 * word;#;DocID	tf(term-frequency)
	 */
	public static class IntSumReducer extends
		...
		public void reduce(Text key, Iterable<Text> values,
			...
			for(Text val : values){
				wordFrequency++;
				wordPerDoc = Double.parseDouble(val.toString());
			}
	...
	public static void main(String[] args) throws Exception {
		...
		job.setJarByClass(ImageTermFrequency.class);
