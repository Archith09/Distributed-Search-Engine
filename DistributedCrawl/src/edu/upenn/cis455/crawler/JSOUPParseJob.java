...
public class JSOUPParseJob {
	...
	public static void main(String[] args) throws IOException {
		 ...
		 * Runtime.getRuntime().totalMemory(); System.out.println(heapSize);
		 * 
		 * 
		 * // Get maximum size of heap in bytes. The heap cannot grow beyond
		 * this size.// Any attempt will result in an OutOfMemoryException. long
		 * heapMaxSize = Runtime.getRuntime().maxMemory();
		 * System.out.println(heapMaxSize);
		 * 
		 * // Get amount of free memory within the heap in bytes. This size will
		 * increase // after garbage collection and decrease as new objects are
		 * created. long heapFreeSize = Runtime.getRuntime().freeMemory();
